...
{
    long long int oldSum = getOldValue((char*)"payments.txt");
...
{
    char path[300] = "C:\\Users\\Laura\\Desktop\\Tema3_CSSO\\payments\\";
    strcat(path, file);
    //cout << "Full path: " << path << '\n';
    ifstream crtFile;
    crtFile.open(path);
...
long long int scanDirectory()
{
    ...
    HANDLE hDir = FindFirstFile("C:\\Users\\Laura\\Desktop\\Tema3_CSSO\\payments\\*", &fileData);
...
{
    /*
    parcurge fisierele din directorul 'payments' si pt fiecrae linie din
    fisierele parcurse, scrie in fisierul "C:\\Facultate\CSSO\Week3\Reports\logs.txt"
    o linie de tipul "S-a facut o plata <valoare> in data de <nume fisier>"
    */
    cout << "Pay.exe started.\n";
